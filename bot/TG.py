...
class TelegramBot:
    ...
    def handle_profiles(self, update: Update, args):
    ...
    def handle_clan2(self, update: Update, args):
    ...
    def handle_player(self, update: Update, args):
        ...
        print("айди = " + str(user_id) + " arg = " + str(args))
        if args != None:
            search_id = args
        else:
            search_id = user_id
    ...
    def handle_weapons_ttk(self, update: Update, args):
        if not args:
            return "Укажите название оружия"
